...
const eventsDashboard = [
  {
    ...
    category: 'culture',
    description:
      'xyz dolor sit amet, consectetur adipiscing elit. Phasellus sollicitudin ligula eu leo tincidunt, quis scelerisque magna dapibus. Sed eget ipsum vel arcu vehicula ullamcorper.',
    city: 'London, UK',
  ...
  render() {
    ...
    return (
       <Grid>
         ...
         <Grid.Column width={6}>
           <Button onClick= {this.handleFromOpen}positive content='Create Event'/>
           {
             this.state.isOpen &&
